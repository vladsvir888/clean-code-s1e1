...
var createNewTaskElement=function(taskString){
    ...
    label.className='section__list-label';

    //Each elements, needs appending
    checkBox.classList.add('section__list-input');
    checkBox.type="checkbox";
    editInput.type="text";
    editInput.className="input section__input section__input_hidden";
    ...
    deleteButtonImg.alt = 'Remove the item from incompleted tasks.';
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    listItem.querySelector('label').classList.add('section__list-label_completed');
    listItem.querySelector('img').alt = 'Remove the item from completed tasks.';
...
//Mark task as incomplete.
    ...
    var listItem=this.parentNode;
    listItem.querySelector('label').classList.remove('section__list-label_completed');
    listItem.querySelector('img').alt = 'Remove the item from incompleted tasks.';
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
